...
class ROMASTORIA_API ARS_FPSHUD : public AHUD
{
	...
	/* Start Image Slot Texture */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = HUD)
		UTexture2D* StartImage;
...
public:
	...
	TArray<FRS_FPSHUDButtonStruct> ButtonsMain;
	TArray<FRS_FPSHUDButtonStruct> ButtonsConfirm;
	TArray<FRS_FPSHUDButtonStruct> ButtonsNotebook;

	const FRS_FPSHUDButtonStruct* CurCheckButton;
	int32 CheckCursorInButton(const TArray<FRS_FPSHUDButtonStruct>& ButtonArray);
...
public:
	...
	void CheckCursorInButtonsNotebook();

	/* Buttons */
	void DrawMainMenuButtons();
	void DrawConfirmButtons();
	void DrawNotebookButtons();
	void DrawToolTip();
